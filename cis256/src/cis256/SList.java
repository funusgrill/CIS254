...
public class SList {
  ...
  public static void main (String[] args) { 
    ...
    // Fill in your solution for Part I here.
	  ...
	  SListNode head = new SListNode(new Integer (6), new SListNode(
	  new Integer (9), new SListNode(new Integer (12))));
	  myList.head  = head;
	  System.out.println("Here is my list: " + myList.toString());
	  myList.insertFront(new Integer (3));
	  myList.insertEnd(new Integer (15));
	  System.out.println("Here is my list after insertion: " + myList.toString());
